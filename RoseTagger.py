...
BOT_TOKEN = os.environ.get("TOKEN", "7623596811:AAFXYPJ-vRnj3bQXdkBzQocwiDx5C4fOzqw")  

BOT_ID = int(os.environ.get("BOT_ID", "7442492919"))  

BOT_USERNAME = os.environ.get("BOT_USERNAME", "promuziktrbot")  
LOG_CHANNEL = int(os.environ.get("LOG_CHANNEL", "-1002496017349")  
